...
function main() {
    ...
    push(results, 'frame', '不再 re-export 已删除的数据库设置页 builder', !has(contents.frame, 'buildDatabasePageHtml'));
    push(results, 'frame', '不再 re-export [`buildPromptEditorPageHtml()`](modules/settings-app/layout/frame.js:1)', !has(contents.frame, 'buildPromptEditorPageHtml'));
    push(results, 'frame', '不再 re-export [`buildApiPromptConfigPageHtml()`](modules/settings-app/layout/frame.js:1)', !has(contents.frame, 'buildApiPromptConfigPageHtml'));
    ...
    push(results, 'pageBuilders', '不再存在已删除的数据库设置页 builder', !has(contents.pageBuilders, 'buildDatabasePageHtml'));
    ...
    push(results, 'pageBuilders', '不再存在 [`buildPromptEditorPageHtml()`](modules/settings-app/layout/page-builders.js:1)', !has(contents.pageBuilders, 'buildPromptEditorPageHtml'));
    push(results, 'pageBuilders', '不再存在 [`buildApiPromptConfigPageHtml()`](modules/settings-app/layout/page-builders.js:1)', !has(contents.pageBuilders, 'buildApiPromptConfigPageHtml'));
