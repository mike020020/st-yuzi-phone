...
function main() {
    ...
    if (reconcileRetryLoop.includes('refreshTableProjection')) {
    ...
    if (countOccurrences(reconcileBody, 'refreshTableProjection()') !== 1) {
